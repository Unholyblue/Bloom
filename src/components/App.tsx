...
import VibrantWelcomeScreen from './VibrantWelcomeScreen';
import AuthenticatedWelcomeScreen from './AuthenticatedWelcomeScreen';
...
import { SlidingTabMenu } from './SlidingTabMenu';
...
function App() {
  ...
  const createNewSession = () => {
    ...
    setTimeout(() => {
      ...
      // Mark first conversation created if this is their first
      ...
      <div className="h-screen bg-transparent flex overflow-hidden relative">
        ...
        {isMobile && (
          <button
            ...
            className="fixed top-4 right-4 z-30 p-2 bg-therapeutic-pearl rounded-lg shadow-gentle border border-soft-blue-200 focus:outline-none focus:ring-2 focus:ring-soft-blue-300"
